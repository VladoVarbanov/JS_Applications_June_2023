...
let createRecipeTemplate = (submitHandler) =>
  html`<article>
    <form @submit=${submitHandler}>
      <label
        >Name:<input type="text" name="name" placeholder="Recipe Name" /></label
      ><label
        >Image:<input type="text" name="img" placeholder="Image URL" /></label
      ><label
...
async function createRecipe(e) {
  ...
  let result = await recipeService.createRecipe({
    name,
    img,
    ingredients,
    steps,
